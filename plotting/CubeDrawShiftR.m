function CubeDrawShiftR(dx,dy,dz,xc,yc,zc,phi,theta,psi,color)
%function CubeDraw(dx,dy,dz,xc,yc,zc,phi,theta,psi,color)

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

xb = [ 1  1 -1 -1  1  1 -1 -1].*dx/2;
%yb = [0  1  1 0 0 1  1 0].*dy/2;
yb = 2*[-0.58  0.4175  0.4175 -0.58 -0.58 0.4175  0.4175 -0.58].*dy/2;
%yb = [-0.5  1  1 -0.5 -0.5 1  1 -0.5].*dy/2;
